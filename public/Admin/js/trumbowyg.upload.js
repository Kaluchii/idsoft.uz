...
(function ($) {
    ...
    var container = $('.group_container[data-block="dom_all_images"][data-group="images_set"][data-owner-id="0"]');
    ...
    $.extend(true, $.trumbowyg, {
        ...
        upload: {
            serverPath: '/adm/create_group_image',
            fileFieldName: 'imagefile',//
            data: [
                {name: 'block_name', value: 'dom_all_images'},
                {name: 'group_name', value: 'images_set'},
                {name: 'image_name', value: 'text_pict'}
            ],
